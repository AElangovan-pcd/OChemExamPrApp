...
var CH05_QUESTIONS = [
  ...
  },
  {
    ...
    "feedback": {
      ...
      "note": "The driving force is real but small: the entropy of mixing gives about 5.8 J per mole per kelvin (R ln 2), worth roughly 0.4 kcal/mol of free energy at room temperature. That is why enantiopure compounds sit stable on a shelf for decades - not because racemising them is uphill, but because there is usually no pathway with a low enough barrier. Thermodynamics says it will happen; kinetics decides whether you live to see it.",
      "options": {
