...
const CHAPTER_27_QUESTIONS = [
  ...
  {
    "question_id": "ch27_acs_q6_malonic",
    "topic": "ACS: Enols & Enolate Reactions",
    "difficulty_level": "Hard",
    "question_text": "What is the final organic product of the malonic ester synthesis using diethyl malonate, sodium ethoxide, 1-bromobutane, followed by heating in dilute aqueous acid?",
    "question_smiles": "CCOC(=O)CC(=O)OCC.CCCCBr",
    "options": [
      {
        "option_id": "A",
        "text": "Hexanoic acid",
      ...
      {
        "option_id": "D",
        "text": "Butylmalonic acid",
        "is_correct": false
      }
    ],
    "feedback": {
      "context": "Understanding the steps of malonic ester synthesis.",
      "process": "Step 1: Deprotonation of diethyl malonate with ethoxide, followed by alkylation with 1-bromobutane adds a butyl group (4 carbons).\nStep 2: Heating in aqueous acid hydrolyzes the two ester groups to form a beta-dicarboxylic acid.\nStep 3: Decarboxylation expels CO2 to yield hexanoic acid.",
      "result": "The product is hexanoic acid."
    }
  },
  {
    "question_id": "ch27_acs_q7_michael",
    "topic": "ACS: Enols & Enolate Reactions",
    "difficulty_level": "Medium",
    "question_text": "What is the product of the Michael addition of diethyl malonate to methyl vinyl ketone in the presence of sodium ethoxide?",
    "question_smiles": "CCOC(=O)CC(=O)OCC.CC(=O)C=C",
    "options": [
      {
        "option_id": "A",
        "text": "Ethyl 2-carbethoxy-5-oxohexanoate",
        "is_correct": true
      },
      {
        "option_id": "B",
      ...
      {
        "option_id": "C",
        "text": "1,3-cyclohexanedione",
        "is_correct": false
      },
      {
        "option_id": "D",
        "text": "A 1,2-addition product",
        "is_correct": false
      }
    ],
    "feedback": {
      "context": "Analyzing conjugate addition (Michael addition) of stabilized enolates.",
      "process": "Step 1: Ethoxide deprotonates diethyl malonate to form a stable enolate.\nStep 2: The enolate is a soft nucleophile and attacks the beta-carbon of the alpha,beta-unsaturated ketone (conjugate addition).\nStep 3: Protonation yields the Michael addition product.",
      "result": "The reaction yields the Michael adduct."
    }
  },
  {
    "question_id": "ch27_acs_q8_robinson",
    "topic": "ACS: Enols & Enolate Reactions",
    "difficulty_level": "Hard",
    "question_text": "What is the product of the Robinson annulation between cyclohexanone and methyl vinyl ketone (MVK) under basic conditions?",
    "question_smiles": "O=C1CCCCC1.CC(=O)C=C",
    "options": [
      {
        "option_id": "A",
        "text": "A bicyclic alpha,beta-unsaturated ketone (enone)",
        "is_correct": true
      },
      {
        "option_id": "B",
        "text": "A monocyclic 1,5-diketone",
        "is_correct": false
      },
      {
        "option_id": "C",
        "text": "A spiro compound",
        "is_correct": false
      },
      {
        "option_id": "D",
        "text": "A beta-hydroxy ketone",
        "is_correct": false
      }
    ],
    "feedback": {
      "context": "Investigating Robinson annulation steps.",
      "process": "Step 1: Cyclohexanone enolate attacks MVK in a Michael addition to form a 1,5-diketone intermediate.\nStep 2: Intramolecular aldol condensation occurs where the methyl group of the added chain attacks the ring carbonyl.\nStep 3: Dehydration yields a fused six-membered ring (bicyclic enone).",
      "result": "A bicyclic enone is formed."
    }
  },
  {
    "question_id": "ch27_acs_q9_kinetic",
    "topic": "ACS: Enols & Enolate Reactions",
    "difficulty_level": "Hard",
    "question_text": "Which conditions are most appropriate for selective alkylation of 2-methylcyclohexanone at the less substituted alpha-carbon (kinetic enolate formation)?",
    "question_smiles": "CC1CCCCC1=O",
    "options": [
      {
        "option_id": "A",
      ...
      {
        "option_id": "C",
        "text": "1) NaOEt, EtOH, heat; 2) CH3I",
        "is_correct": false
      },
      {
        "option_id": "D",
        "text": "1) HCl, heat; 2) CH3I",
        "is_correct": false
      }
    ],
    "feedback": {
  ...
  {
    "question_id": "ch27_acs_q10_decarboxylation",
    "topic": "ACS: Enols & Enolate Reactions",
    "difficulty_level": "Medium",
    "question_text": "Heating a beta-keto acid (such as acetoacetic acid) causes decarboxylation. What intermediate is directly formed in this thermal mechanism?",
    "question_smiles": "CC(=O)CC(=O)O",
    "options": [
      {
        "option_id": "A",
        "text": "An enol intermediate, which rapidly tautomerizes to the ketone.",
        "is_correct": true
      },
      {
        "option_id": "B",
