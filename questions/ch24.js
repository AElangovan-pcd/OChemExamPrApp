...
var CH24_QUESTIONS = [
  ...
  },
  {
    ...
    "feedback": {
      "context": "The Henderson-Hasselbalch equation applies to an amine exactly as to a carboxylic acid, with the ammonium ion as HA and the free amine as A-: log([RNH2]/[RNH3+]) = pH - pKa. An alkylamine's conjugate acid has a pKa near 10 or 11, more than three units above physiological pH, so the ratio of free amine to ammonium ion is about 10^-3.3: the amine is protonated almost completely. That is why simple alkylamines, whose conjugate acids have pKa values near 10 to 11, are conventionally written in their protonated form and amino acids as ammonium carboxylates. Only much weaker bases, such as pyrimidine (pKa 1.3) or imidazole (pKa 6.95), are substantially neutral at pH 7.3.",
  ...
  },
  {
    ...
    "feedback": {
      ...
      "options": {
        ...
        "B": "Benzaldehyde has no carbon between the ring and the carbonyl: PhCHO. Reductive amination with methylamine gives N-methylbenzylamine, PhCH2NHCH3, one carbon short of the target.",
  ...
  },
  {
    ...
    "topic": "Structure Elucidation: Multi-Spectral",
    "difficulty_level": "Hard",
    "question_text": "Compound N is a low-melting solid (mp 44 °C) that darkens in air. It dissolves in dilute HCl; treating that solution with NaNO2 at 0 °C and then adding it to alkaline phenol gives an orange precipitate. Combustion analysis gives C 78.5%, H 8.5% and N 13.1% by mass. IR: two bands at 3430 and $3350\\text{ cm}^{-1}$, bands at 1620, 1515 and $1270\\text{ cm}^{-1}$, and a strong band at $815\\text{ cm}^{-1}$; nothing between 1650 and $1800\\text{ cm}^{-1}$ and no absorption near $2250\\text{ cm}^{-1}$. Mass spectrum: $\\text{M}^+$ at $m/z = 107$ (intense) and a base peak at 106 (M - 1). The $^1\\text{H}$ NMR spectrum is shown. Which structure is N?",
    "question_smiles": "",
    "dynamic_spectroscopy": {
      "spec_type": "nmr",
      "data_points": [
