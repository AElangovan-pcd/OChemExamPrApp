...
var CH06_QUESTIONS = [
  {
    ...
    "feedback": {
      "context": "An activation energy is measured upward from whatever species enters the step, and an enthalpy change is measured between the two ends of the whole profile. Neither one can be read directly off the axis.",
      "approach": "Step 1: The first step begins at the reactants, so its barrier is 93 - 20 = 73 kJ/mol.\nStep 2: The overall change runs from reactants to products: -5 - 20 = -25 kJ/mol.\nStep 3: Check the sign visually. The right-hand end of the curve sits lower than the left, so energy is released.",
      "note": "The first transition state at 93 is the highest point anywhere on this profile, above the second at 88, so here the step with the larger barrier is also the rate-determining one. That agreement is common but not automatic, and it is worth checking on each new diagram rather than assuming it.",
      "options": {
        "A": "32 kJ/mol is the rise from the reactants to the intermediate at 52. An intermediate sits in a valley, not on the peak the first step has to clear.",
        "B": "93 kJ/mol is where the first transition state sits on the axis, not the height climbed to reach it from 20.",
        "C": "Correct. 93 - 20 = 73 kJ/mol for the first barrier, and -5 - 20 = -25 kJ/mol for the reaction overall.",
        "D": "The barrier is right, but products at -5 finish below reactants at 20, so the enthalpy change cannot come out positive."
      }
    },
    "key_status": "verified",
  ...
  },
  {
    ...
    "feedback": {
      "context": "This profile combines both of the less common features at once - an overall uphill reaction and a second barrier larger than the first - so it repays reading slowly.",
      "approach": "Step 1: The first barrier is 60 - 20 = 40 kJ/mol.\nStep 2: The overall change is 45 - 20 = +25 kJ/mol, positive because the products finish higher than the reactants.\nStep 3: Look at the second step out of interest: 84 - 36 = 48 kJ/mol, larger than the first.",
      "note": "With the second transition state at 84 standing well above the first at 60, and the products above the reactants as well, a reaction with this profile is both slow to complete and unfavourable at equilibrium. Those are separate statements: the barrier accounts for the first and the difference between the ends for the second.",
      "options": {
        "A": "The barrier is right, but the products at 45 sit above the reactants at 20, so the enthalpy change is positive rather than negative.",
        "B": "16 kJ/mol is the rise from the reactants to the intermediate at 36, which is the valley lying beyond the first peak.",
        "C": "Correct. 60 - 20 = 40 kJ/mol for the first barrier, and 45 - 20 = +25 kJ/mol for the overall change.",
        "D": "60 kJ/mol is where the first peak sits rather than the climb to it, and 35 is not the difference between the two ends."
      }
    },
    "key_status": "verified",
    "feedback_status": "tailored",
  ...
  },
  {
    ...
    "feedback": {
      "context": "A late transition state resembles whatever comes after it, and that resemblance is more than a matter of drawing. It means the transition state responds to substituent effects in the same way the product or intermediate does.",
      "approach": "Step 1: Place the transition state along the coordinate. In an endothermic step the products lie above the reactants, so the barrier is crossed late in the process.\nStep 2: Apply the postulate. Late means close in energy to the product or intermediate, and close in energy means close in structure.\nStep 3: Draw the consequence out. Anything that lowers the energy of that product or intermediate lowers the transition state with it, which lowers the activation energy and speeds the step up.",
      "note": "This is the whole argument behind Markovnikov's rule in Chapter 7. Protonating an alkene is endothermic, so its transition state resembles the carbocation, and the more stable of the two possible cations is therefore reached over the lower barrier. A statement about the stability of an intermediate becomes a statement about rate.",
      "options": {
        "A": "Stabilising the reactants matters for an early transition state, which is the exothermic case. Here the transition state has already moved structurally far from the starting material.",
        "B": "Correct. A late transition state resembles the product or intermediate of that step, so whatever stabilises them stabilises it as well and lowers the barrier.",
        "C": "Bond lengths identical to the starting material would describe an extremely early transition state, which is the opposite of what the postulate predicts for an endothermic step.",
        "D": "A barrier of zero would mean no transition state at all, and an endothermic step must climb at least as far as its own products lie above the reactants."
      }
    },
    "key_status": "verified",
    "feedback_status": "tailored",
  ...
  },
  {
    ...
    "options": [
      {
        "option_id": "A",
        "text": "The reaction is exothermic (delta H = -40 kJ/mol) and the first step is rate-limiting (Ea = 70 kJ/mol).",
        "is_correct": true
      },
      {
        "option_id": "B",
        "text": "The reaction is endothermic and passes through a single transition state.",
        "is_correct": false
      },
      {
        "option_id": "C",
    ...
    "feedback": {
      "context": "This diagram asks for a description rather than a pair of numbers, so the work is to test each claim against the picture: how many peaks there are, which of them is highest, and which end of the curve finishes lower.",
      "approach": "Step 1: Count the peaks. There are two, so the mechanism has two steps with one intermediate between them - the carbocation sitting at 40.\nStep 2: Compare the barriers. The first is 80 - 10 = 70 kJ/mol and the second only 60 - 40 = 20, and the first transition state is the higher in absolute terms too, so step one limits the rate on both readings.\nStep 3: Compare the ends. Products at -30 against reactants at 10 give -40 kJ/mol, so the reaction gives out energy.",
      "note": "Both features are typical of an electrophilic addition. Forming the carbocation is the slow, uphill part, and the rapid capture of that cation afterwards pays back far more than the first step cost. This is precisely the shape Chapter 7 uses to justify Markovnikov's rule.",
      "options": {
        "A": "Correct. The products finish 40 kJ/mol below the reactants, and the first barrier of 70 kJ/mol far exceeds the second at 20, so the first step is rate-limiting.",
        "B": "There are two peaks on this diagram rather than one, and the products end below the reactants rather than above them, so both halves of this description fail.",
        "C": "The second barrier is only 20 kJ/mol against 70 for the first, and its transition state at 60 is lower than the first at 80, so the second step is the fast one.",
        "D": "The intermediate sits at 40 while the product sits at -30, so the intermediate is much the higher in energy and therefore the less stable of the two."
      }
    },
    "key_status": "verified",
    "feedback_status": "tailored",
  ...
  },
  {
    ...
    "feedback": {
      "context": "Where the zero of the vertical axis happens to fall carries no chemical meaning at all. Both quantities asked for are differences, so a product level sitting above zero says nothing about whether the reaction gives out energy.",
      "approach": "Step 1: The climb to the first transition state is 74 - 20 = 54 kJ/mol.\nStep 2: The difference between the ends is 5 - 20 = -15 kJ/mol.\nStep 3: The products at 5 are above the zero line yet below the reactants at 20, and it is the comparison with the reactants that fixes the sign.",
      "note": "The second transition state at 92 is the highest point here, above the first at 74, so the second step determines the rate - and it does so even though its climb out of the intermediate, 46 kJ/mol, is smaller than the first step's 54. What must be cleared is the summit above the reactants, not the individual climb.",
      "options": {
        "A": "26 kJ/mol is the rise from the reactants to the intermediate at 46, not the climb to the first peak at 74.",
        "B": "Both figures here are positions rather than differences: 74 is where the first peak sits and 5 is where the products sit, neither measured against the reactants at 20.",
        "C": "Correct. 74 - 20 = 54 kJ/mol for the first barrier, and 5 - 20 = -15 kJ/mol for the reaction overall.",
        "D": "The barrier is right, but products below reactants means energy is released, so the sign has to be negative."
      }
    },
    "key_status": "verified",
    "feedback_status": "tailored",
  ...
  },
  {
    ...
    "feedback": {
      "context": "The question asks specifically for the barrier of the first step, which is not always the largest barrier on the diagram. Read what is asked rather than what is biggest.",
      "approach": "Step 1: The first step climbs from 20 to 63, so its barrier is 43 kJ/mol.\nStep 2: The two ends lie at 20 and 5, so the overall change is -15 kJ/mol.\nStep 3: Note in passing that the second barrier, 105 - 55 = 50 kJ/mol, is the larger of the two - useful to know, but not what was asked for.",
      "note": "This is the shape in which the second step is unambiguously rate-determining: its transition state at 105 towers over the first at 63, and its own climb of 50 kJ/mol also exceeds the first step's 43. The intermediate at 55 sits in a very shallow well and reverts to reactants easily.",
      "options": {
        "A": "Correct. 63 - 20 = 43 kJ/mol for the first barrier, and 5 - 20 = -15 kJ/mol from one end of the profile to the other.",
        "B": "35 kJ/mol is the rise from the reactants to the intermediate at 55, not the climb to the first transition state at 63.",
        "C": "Both values here are positions on the axis rather than differences measured from the reactant level at 20.",
        "D": "The barrier is right, but the products at 5 finish below the reactants at 20, so this reaction releases energy."
      }
    },
    "key_status": "verified",
    "feedback_status": "tailored",
  ...
  },
  {
    ...
    "feedback": {
      "context": "Two subtractions again, on a profile where the taller hill comes second. The order in which the barriers appear makes no difference at all to how either quantity is worked out.",
      "approach": "Step 1: The first step's barrier is 63 - 20 = 43 kJ/mol.\nStep 2: The overall change is -5 - 20 = -25 kJ/mol.\nStep 3: Confirm the sign from the shape - the curve ends below where it began, so the reaction is exothermic.",
      "note": "The second transition state at 89 is by far the higher of the two, and the second barrier, 48 kJ/mol measured from the intermediate at 41, is the larger as well. Both readings agree that the second step is rate-determining, which is the reverse of the more common arrangement.",
      "options": {
        "A": "Correct. 63 - 20 = 43 kJ/mol to reach the first transition state, and -5 - 20 = -25 kJ/mol from one end to the other.",
        "B": "The barrier is right but the sign is inverted. The products at -5 lie below the reactants at 20, so energy is released.",
        "C": "21 kJ/mol is the rise from the reactants to the intermediate at 41, which lies beyond the first peak rather than at it.",
        "D": "63 kJ/mol is the position of the first peak on the axis, and -15 is not the difference between the two ends either."
      }
    },
    "key_status": "verified",
    "feedback_status": "tailored",
  ...
  },
  {
    ...
    "feedback": {
      ...
      "options": {
        ...
        "C": "Both numbers have been read straight off the axis - 64 is where the first peak sits and 5 where the products sit - instead of being measured against the reactants.",
        "D": "Correct. 64 - 20 = 44 kJ/mol for the first barrier, and 5 - 20 = -15 kJ/mol for the overall change."
      }
    },
    "key_status": "verified",
    "feedback_status": "tailored",
  ...
  },
  {
    ...
    "feedback": {
      "context": "Two quantities, two subtractions, and one sign to settle. The sign follows entirely from which end of the profile finishes higher than the other.",
      "approach": "Step 1: The climb to the first transition state is 87 - 20 = 67 kJ/mol.\nStep 2: The difference between the two ends is 45 - 20 = +25 kJ/mol.\nStep 3: The value is positive because the products at 45 sit above the reactants at 20, which is what endothermic looks like on a diagram.",
      "note": "The two peaks here are close together, 87 and 94, with the second the higher. Each is climbed from a different starting level, so the barriers are 67 and 45 respectively: the first step has the larger climb while the second has the higher summit. When those two disagree, it is the summit measured from the reactants that governs the overall rate.",
      "options": {
        "A": "29 kJ/mol measures the rise from the reactants to the intermediate at 49, not the climb to the first peak at 87.",
        "B": "The barrier is right but the sign is not. Products above reactants means an endothermic reaction and a positive enthalpy change.",
        "C": "87 kJ/mol is the position of the first peak rather than the climb to it, and 35 corresponds to no pair of points on the diagram.",
        "D": "Correct. 87 - 20 = 67 kJ/mol to the first transition state, and 45 - 20 = +25 kJ/mol overall."
      }
    },
    "key_status": "verified",
    "feedback_status": "tailored",
  ...
  },
  {
    ...
    "feedback": {
      "context": "The same two subtractions apply whichever way a reaction runs energetically. Only the sign of the second one changes, and it changes because the products finish above the reactants rather than below them.",
      "approach": "Step 1: Take the climb to the first transition state: 73 - 20 = 53 kJ/mol.\nStep 2: Take the difference between the ends: 45 - 20 = +25 kJ/mol, positive this time.\nStep 3: Check it against the picture. The right-hand end stands higher than the left, so the reaction absorbs energy overall.",
      "note": "The highest point on this profile is the second transition state at 91, not the first at 73. Measured from the reactants that is a hurdle of 71 kJ/mol against 53 for the first step, so the second step governs the rate even though the climb out of the intermediate looks like the shorter one.",
      "options": {
        "A": "Correct. 73 - 20 = 53 kJ/mol for the first barrier, and 45 - 20 = +25 kJ/mol for the change from end to end.",
        "B": "27 kJ/mol is the rise from the reactants up to the intermediate at 47, which is the valley rather than the first peak.",
        "C": "The barrier is right, but the products at 45 finish above the reactants at 20, so this reaction takes energy in rather than giving it out.",
        "D": "73 kJ/mol is the position of the first peak rather than the height climbed to it, and 35 matches neither end of the diagram."
      }
    },
    "key_status": "verified",
    "feedback_status": "tailored",
  ...
  },
  {
    ...
    "feedback": {
      "context": "The vertical axis of a reaction coordinate diagram is a scale, not a list of answers. Every quantity this question asks for is the distance between two marked points on that scale.",
      "approach": "Step 1: Subtract for the first barrier. 82 - 20 = 62 kJ/mol.\nStep 2: Subtract for the overall change. -5 - 20 = -25 kJ/mol.\nStep 3: Confirm the direction. The profile finishes lower than it started, so the reaction is exothermic and the sign is negative.",
      "note": "This diagram has an unusual feature: both transition states sit at exactly the same energy, 82 kJ/mol. Equal summits do not mean equal barriers, because the second is climbed from the intermediate at 42 rather than from the reactants at 20 - a rise of 40 against 62. The first step is the slower of the two.",
      "options": {
        "A": "Correct. The climb to the first summit is 82 - 20 = 62 kJ/mol, and the two ends differ by -5 - 20 = -25 kJ/mol.",
        "B": "82 kJ/mol is the position of the first transition state, not the distance the reactants climb to reach it, and the enthalpy value fits neither end of the diagram.",
        "C": "22 kJ/mol measures the rise from the reactants up to the intermediate, which is the valley between the peaks rather than the first peak itself.",
        "D": "The barrier is right but the enthalpy sign is inverted. Products at -5 finish below reactants at 20, so energy is released overall."
      }
    },
    "key_status": "verified",
    "feedback_status": "tailored",
  ...
  },
  {
    ...
    "feedback": {
      "context": "Reading this profile takes the same two subtractions as any other, but the large numbers on the axis make it especially tempting to quote a position where a difference is what the question wants.",
      "approach": "Step 1: The climb from the reactants at 20 to the first peak at 114 is 94 kJ/mol.\nStep 2: The two ends lie at 20 and -5, so the overall change is -25 kJ/mol.\nStep 3: Read the shape as a check - one very tall hill, a deep valley at 45, then a much smaller hill at 66.",
      "note": "The asymmetry is what makes this diagram worth studying. The first barrier is 94 kJ/mol while the second, from the intermediate at 45 up to the peak at 66, is only 21. Once a molecule has cleared that first hill it is effectively committed, and the intermediate is consumed almost as quickly as it forms.",
      "options": {
        "A": "114 kJ/mol is where the first peak sits, not the distance climbed to reach it, and the enthalpy quoted matches no pair of points on this diagram.",
        "B": "25 kJ/mol is the rise from the reactants to the intermediate, and that valley is reached only after the peak at 114 has already been crossed.",
        "C": "The barrier is right, but the products finish below the reactants, so the enthalpy change must carry a negative sign.",
        "D": "Correct. 114 - 20 = 94 kJ/mol to reach the first transition state, and -5 - 20 = -25 kJ/mol from end to end."
      }
    },
    "key_status": "verified",
    "feedback_status": "tailored",
  ...
  },
  {
    ...
    "feedback": {
      "context": "The height of the barrier and the size of the overall energy change are independent readings taken from the same picture, and this profile shows just how far apart the two can be.",
      "approach": "Step 1: The first activation energy is 91 - 20 = 71 kJ/mol.\nStep 2: The overall enthalpy change is 35 - 20 = +15 kJ/mol.\nStep 3: Notice the mismatch - a hurdle of 71 kJ/mol for a reaction that finishes only 15 kJ/mol uphill.",
      "note": "That mismatch is the lesson. A modest thermodynamic cost says nothing at all about how hard the reaction is to start. Kinetics is fixed by the barrier and thermodynamics by the difference between the ends, and neither quantity predicts the other.",
      "options": {
        "A": "91 kJ/mol is the height of the first peak on the axis rather than the climb from the reactants, and 25 is not the gap between the ends either.",
        "B": "24 kJ/mol is the rise from the reactants to the intermediate at 44, which is the valley lying between the two peaks.",
        "C": "The barrier is right but the sign is wrong. Products at 35 finish above reactants at 20, so the reaction is endothermic.",
        "D": "Correct. 91 - 20 = 71 kJ/mol to reach the first transition state, and 35 - 20 = +15 kJ/mol from end to end."
      }
    },
    "key_status": "verified",
    "feedback_status": "tailored",
  ...
  },
  {
    ...
    "feedback": {
      "context": "Both quantities asked for are differences measured on the vertical axis, never energies read straight off it. The activation energy is the climb from the reactants to the first peak; the enthalpy change is the gap between the two ends of the profile.",
      "approach": "Step 1: Take the first barrier. The reactants sit at 20 and the first transition state at 60, so Ea1 = 60 - 20 = 40 kJ/mol.\nStep 2: Take the overall change. Products at -15 against reactants at 20 give delta H = -15 - 20 = -35 kJ/mol.\nStep 3: Check the sign against the picture. The right-hand end finishes below the left, so the reaction gives out energy and the value must be negative.",
      "note": "The two individual barriers here are all but identical - 40 kJ/mol for the first step and 39 for the second - yet the second transition state stands at 77 against 60 for the first. Measured from the reactants it is the higher hurdle, so the second step limits the rate even though its own climb is the smaller of the two numbers.",
      "options": {
        "A": "The magnitude is right, but products at -15 lie below reactants at 20, so the enthalpy change has to carry a negative sign.",
        "B": "Correct. 60 - 20 = 40 kJ/mol to reach the first transition state, and -15 - 20 = -35 kJ/mol from one end of the profile to the other.",
        "C": "18 kJ/mol is the rise from the reactants to the intermediate at 38. That valley is only reached after the peak at 60 has been crossed.",
        "D": "60 kJ/mol is where the first transition state sits on the axis rather than the height climbed to reach it, and the enthalpy quoted matches neither end."
      }
    },
    "key_status": "verified",
    "feedback_status": "tailored",
  ...
  },
  {
    ...
    "feedback": {
      "context": "A tall barrier and a small overall change often turn up on the same profile, and the two are read in completely different ways: one is a climb from a starting level, the other a comparison of the two ends.",
      "approach": "Step 1: The climb to the first transition state is 106 - 20 = 86 kJ/mol.\nStep 2: The difference between the ends is 45 - 20 = +25 kJ/mol.\nStep 3: The products sit above the reactants, so the sign is positive even though the curve drops steeply after the first peak.",
      "note": "Beyond the first peak at 106 everything on this diagram is lower - the intermediate at 49 and the second transition state at 70 both sit well beneath it. A molecule that has reached 106 has already done the hard part, and the remaining barrier of 21 kJ/mol is crossed almost at once.",
      "options": {
        "A": "Correct. 106 - 20 = 86 kJ/mol for the first barrier, and 45 - 20 = +25 kJ/mol for the change from end to end.",
        "B": "29 kJ/mol is the rise from the reactants to the intermediate at 49, a valley that lies beyond the first peak rather than at it.",
        "C": "106 kJ/mol is where the first peak sits on the axis, not the height climbed to reach it, and 35 matches neither end of the diagram.",
        "D": "The barrier is right, but the products at 45 finish above the reactants at 20, so the enthalpy change comes out positive."
      }
    },
    "key_status": "verified",
    "feedback_status": "tailored",
