  ...
  },
  {
    ...
    "feedback": {
      ...
      "options": {
        ...
        "C": "Lard is more unsaturated than butter or coconut oil, but its 40% saturated chains (palmitic and stearic) crystallise and make it a soft solid; corn oil has about a third as much saturated material and far more linoleic acid.",
  ...
  },
  {
    ...
    "feedback": {
      ...
      "options": {
        ...
        "B": "The C19 methyl sits on C10, across the ring from C3 and axial; it is on the same (beta) face as the equatorial 3-OH but is not hydrogen-bonded to it. The rigidity comes from the ring fusions, not from a hydrogen bond.",
